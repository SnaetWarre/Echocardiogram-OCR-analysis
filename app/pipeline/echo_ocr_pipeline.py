                    ...
                    raw_line_predictions.append(
                        {
                            ...
                            "char_retry_min_char_confidence": line.metadata.get("char_retry_min_char_confidence"),
                            "char_count_expected": line.metadata.get("char_count_expected"),
                            "char_count_predicted": line.metadata.get("char_count_predicted"),
                            "pre_char_line_text": line.metadata.get("pre_char_line_text"),
                            "line_ocr_char_count": line.metadata.get("line_ocr_char_count"),
                            "line_ocr_count_matches": line.metadata.get("line_ocr_count_matches"),
                            "vertical_slice_retry_attempted": line.metadata.get("vertical_slice_retry_attempted"),
                            "vertical_slice_retry_text": line.metadata.get("vertical_slice_retry_text"),
                            "vertical_slice_retry_status": line.metadata.get("vertical_slice_retry_status"),
                            "vertical_slice_retry_char_count": line.metadata.get("vertical_slice_retry_char_count"),
                            "vertical_slice_retry_count_matches": line.metadata.get("vertical_slice_retry_count_matches"),
                            "best_available_text": line.metadata.get("best_available_text"),
                            "best_text_source": line.metadata.get("best_text_source"),
                            "review_status": line.metadata.get("review_status"),
                            "accept_for_training": line.metadata.get("accept_for_training"),
                            "needs_manual_review": line.metadata.get("needs_manual_review"),
                            "retry_diagnostics": line.metadata.get("retry_diagnostics"),
            ...
            line_predictions_payload = [
                {
                    ...
                    "char_retry_min_char_confidence": None,
                    "char_count_expected": None,
                    "char_count_predicted": None,
                    "pre_char_line_text": None,
                    "line_ocr_char_count": None,
                    "line_ocr_count_matches": None,
                    "vertical_slice_retry_attempted": None,
                    "vertical_slice_retry_text": None,
                    "vertical_slice_retry_status": None,
                    "vertical_slice_retry_char_count": None,
                    "vertical_slice_retry_count_matches": None,
                    "best_available_text": None,
                    "best_text_source": None,
                    "review_status": None,
                    "accept_for_training": None,
