...
class MainWindowBatchMixin:
    ...
    def _start_ui_batch_run(self) -> None:
        if self._ui_batch_running:
    ...
    def _log_ui_batch_result(self, ok: bool, message: str) -> None:
    ...
    def _finish_ui_batch(self) -> None:
    ...
    def _on_batch_finished(self, ok: int, total: int, duration: float) -> None:
        self._set_loading_state(False)
